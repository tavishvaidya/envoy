...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_grpc_grpc = dict(
        project_name = "gRPC",
        project_desc = "Fork of the gRPC C-core containing the S2A TSI implementation.",
        project_url = "https://grpc.io",
        version = "86db7432ac75a66745374a8a4a67dce00164eb57",
        sha256 = "d4505cb6343cfbd3d466e1da3284e44c5b44932b29364a226e4c20ca424cbfa7",
        strip_prefix = "grpc-{version}",
        urls = ["https://github.com/matthewstevenson88/grpc/archive/{version}.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
        release_date = "2021-07-21",
        cpe = "cpe:2.3:a:grpc:grpc:*",
    ),
    com_google_s2a_core = dict(
        project_name = "s2a_core",
        project_desc = "S2A Core imports for Envoy",
        project_url = "https://github.com/google/s2a-core",
        version = "81f6aadc2d25fddd6200212695a2fc4d493f90b9",
        sha256 = "0081a7e9ab3b953e38a56b0a8eaaf7ce8eade35c7f61a4430af683ec397782a6",
        strip_prefix = "s2a-core-{version}",
        urls = ["https://github.com/google/s2a-core/archive/{version}.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
